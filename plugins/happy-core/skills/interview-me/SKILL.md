...
質問は原則として一度に一つずつ行い、各質問へのフィードバックを待ってから次に進んでください。ユーザーが一覧形式のgrillを明示的に望む場合だけ、関連する質問を回答しやすいまとまりにできます。
...
ステップ0は自由記述形式で質問してください。ステップ1以降は、選択肢が自然な場合だけ2〜3個の相互排他的な候補と推奨案を提示し、自由記述でも回答できることを伝えてください。環境が対話UIを提供する場合はそれを使い、提供しない場合は通常の会話で質問します。
...
| ユーザーの希望と無関係に大量の質問を一度に投げる | 原則1問ずつ。一覧形式を望む場合だけ関連質問をまとめる |
